...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1657821472);
user_pref("app.update.lastUpdateTime.background-update-timer", 1657821759);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1657818947);
user_pref("app.update.lastUpdateTime.region-update-timer", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1657818995);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1657821196);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1657826756);
...
user_pref("browser.contextual-services.contextId", "{1d75d46d-e28f-4da6-8c6a-ed997a5be9cd}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{f064add2-ae64-49b9-9619-38d3051d32d9}");
...
user_pref("browser.region.update.updated", 1657818871);
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20220603034133");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1657826727);
...
user_pref("extensions.lastAppBuildId", "20220603034133");
...
user_pref("extensions.webextensions.uuids", "{\"doh-rollout@mozilla.org\":\"cb048f87-8f24-44a5-bc37-6e96253afe45\",\"formautofill@mozilla.org\":\"4caddbd2-1884-4f7b-9134-457d332ff082\",\"pictureinpicture@mozilla.org\":\"b6fcc670-3307-4ede-b541-65c0321f1206\",\"screenshots@mozilla.org\":\"f6d60241-001c-443a-904c-d71a40cc8a03\",\"webcompat-reporter@mozilla.org\":\"e6841d44-eb33-4289-bcba-a5b618d81926\",\"webcompat@mozilla.org\":\"8195097b-483e-45e7-bf52-2a2d11749917\",\"default-theme@mozilla.org\":\"25254e22-0c37-4eb7-8e51-fb28cd1f4ea4\",\"google@search.mozilla.org\":\"fbdeeef6-68ef-4e68-9c16-37a738bc41bb\",\"amazondotcom@search.mozilla.org\":\"61aecc52-b299-434b-9ede-9fb030ea45e0\",\"addons-search-detection@mozilla.com\":\"733687f3-d337-447f-902b-cb6a91e8ea68\",\"wikipedia@search.mozilla.org\":\"3ca4cadf-8d03-4b2f-896a-e2898a27b053\",\"bing@search.mozilla.org\":\"1b79e7ba-00f1-4037-a5f8-d60293e93148\",\"ddg@search.mozilla.org\":\"cfa971a2-6f70-4e8c-b5f7-c621d7521815\"}");
user_pref("extensions.webservice.discoverURL", "");
user_pref("fission.autostart", false);
user_pref("fission.bfcacheInParent", false);
user_pref("fission.experiment.max-origins.last-disqualified", 0);
user_pref("fission.experiment.max-origins.last-qualified", 1657818919);
...
user_pref("media.gmp-manager.buildID", "20220603034133");
user_pref("media.gmp-manager.lastCheck", 1657818937);
...
user_pref("security.sandbox.content.tempDirSuffix", "7c2f2b7f-dea3-48d0-bcdf-f3c1708b3645");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.startup.last_success", 1657826725);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "c0ffeec0-ffee-c0ff-eec0-ffeec0ffeec0");
user_pref("toolkit.telemetry.enabled", false);
user_pref("toolkit.telemetry.previousBuildID", "20220603034133");
